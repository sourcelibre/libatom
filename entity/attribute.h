...
#ifndef __ENTITY_ATTRIBUTE_H__
#define __ENTITY_ATTRIBUTE_H__
...
class Attribute : public Documented
{
    public:
         ...
         */
        Attribute(const char *name, const atom::Message &value, const char *short_doc="", bool type_strict=true);
        /**
         * Returns the value string of this Attribute.
         */
        const atom::Message &getValue();
        /**
         ...
         */
        bool setValue(const atom::Message &value);
        /**

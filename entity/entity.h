...
#ifndef __ENTITY_ENTITY_H__
#define __ENTITY_ENTITY_H__

#include <string>
#include "entity/namedobjectmap.h"
#include "entity/documented.h"
#include "entity/attribute.h"
#include "entity/entitysignal.h"
#include "entity/entitymethod.h"
...
class Entity : public Documented
{
    public:
         ...
         */
        const atom::Message &getAttributeValue(const char *name) const
            throw(BadIndexException);
        /**
         ...
         */
        void setAttributeValue(const char *name, const atom::Message &value)
...
//     protected:
         ...
         */
        bool callMethod(const char * method_name, const atom::Message &arguments, atom::Message & return_value)
            throw(BadIndexException);
